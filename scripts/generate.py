...
def parse_args():
    ...
    parser.add_argument("--ae_use_generative_transpose", action="store_true",
                        help="Use MinkowskiGenerativeConvolutionTranspose in the AE decoder")
...
def load_models(args):
    ...
    ae = GaussianAutoencoder(
        ...
        use_generative_transpose=args.ae_use_generative_transpose,
    ).to(device)
